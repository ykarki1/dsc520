...
voter_turnout_df1 <- read_excel("data/G04ResultsDetail2004-11-02.xls", col_names = FALSE, sheet = "Voter Turnout")
...
voter_turnout_df2 <- read_excel("data/G04ResultsDetail2004-11-02.xls",  
                                sheet = "Voter Turnout", 
                                skip =2 , 
                                col_names = c("ward_precinct", "ballots_cast", "registered_voters", "voter_turnout"))
